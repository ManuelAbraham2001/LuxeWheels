...
const RegisterForm = () => {
    ...
    const handleRegister = (e) => {
        ...
        if (form.nombre.length > 2 && form.apellido.length > 2 && validarEmail(form.email) == true && form.password.length >= 5 && form.fechaNacimiento.length > 0 && (form.telefono.length > 5 && form.telefono.length <= 10) && form.documento.length > 6) {
            setEnviado(true)
            setErrorNombre(false)
            setErrorApellido(false)
            setErrorEmail(false)
        ...
        if (form.telefono < 6 && form.telefono > 10) {
        ...
        <div className="background-image">
            <div className="add-vehicle-container">
                <div className="add-vehicle-form">
                    ...
                    <button disabled={buttonDisabled} style={buttonDisabled ? { background: "#000000b8", cursor: "not-allowed" } : null} className="submit-button" onClick={handleRegister}>
                        Registrarse
                    </button>
                    {enviado && <div>
